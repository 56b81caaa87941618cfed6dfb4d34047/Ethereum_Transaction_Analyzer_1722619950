...
Vue.component("simple_header_component_1722619954", {
    template: `
    <header id="header-section" class="w-full">
        <nav id="nav-bar" class="bg-gradient-to-r from-pink-500 to-purple-600 bg-opacity-70 backdrop-filter backdrop-blur-lg border-gray-200 py-2.5 dark:bg-gray-900 shadow-lg">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a id="logo-link" href="#" class="flex items-center">
                    ...
                    <span id="app-name" class="self-center text-xl font-semibold whitespace-nowrap text-white">EtherScope: Real-Time Ethereum Monitoring</span>
                </a>
                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li id="nav-item-home"><a href="#" class="block py-2 pl-3 pr-4 text-white bg-purple-700 rounded-lg lg:bg-transparent lg:text-white lg:p-0 dark:text-white hover:bg-purple-400 lg:hover:bg-transparent lg:hover:text-pink-300 transition duration-300" aria-current="page">Real-time Monitoring of New Transactions</a></li>
                        <li id="nav-item-1"><a href="#" class="block py-2 pl-3 pr-4 text-white rounded-lg hover:bg-purple-400 lg:hover:bg-transparent lg:hover:text-pink-300 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 transition duration-300">In-depth Analysis of Transaction Data</a></li>
                        <li id="nav-item-2"><a href="#" class="block py-2 pl-3 pr-4 text-white rounded-lg hover:bg-purple-400 lg:hover:bg-transparent lg:hover:text-pink-300 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 transition duration-300">Customizable Alerts for Specific Criteria</a></li>
                        <li id="nav-item-3"><a href="#" class="block py-2 pl-3 pr-4 text-white rounded-lg hover:bg-purple-400 lg:hover:bg-transparent lg:hover:text-pink-300 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 transition duration-300">Seamless Integration with Existing Workflows</a></li>
                    </ul>
                </div>
            </div>
        </nav>
